...
Text Domain: plugin-name-textdomain
*/
 ...
 * TODO: #1
 */
defined('MY_PLUGIN_TD') ? MY_PLUGIN_TD : define('MY_PLUGIN_TD', 'plugin-name-textdomain');

/**
 * Plugin variables.
 * Configure your plugin.
 *
 * TODO: #2 - Define your own values.
 * TODO: #3 - Update the config files names located into the `resources/config` folder.
 * TODO: #4 - Update class namespaces.
 */
$vars = [
    'slug' => 'plugin-key',
    'name' => 'Plugin Name',
